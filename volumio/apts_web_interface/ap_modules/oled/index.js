    	...
    	<div class="oled_wrap">
	    	<div class="oled_settings">
			    <form id ="contrast" action="/" method="post"> 
			        ...
			        <input type = "hidden" name="uds_proxy" value="1" >
			    </form>
...
exports.update_config = function(data,callback){   
    ...
    if(data.uds_proxy){
        let prox_msg = {};
        prox_msg[data["config_key"]] = data.value
        uds_proxy(prox_msg)
    }
    else{uds_proxy( {"restart":1},function(){})}
}

exports.restart_oled = function(data,callback){ uds_proxy( {"restart":1}, callback ) }
